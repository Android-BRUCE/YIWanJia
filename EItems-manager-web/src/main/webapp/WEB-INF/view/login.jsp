...
<div class="login-form">
    ...
    <form class="form" id="formlogin" method="post" onsubmit="return false;">
        <input type="text" class="text" name="username" value="用户名字" onfocus="this.value = '';" id="loginname"
               onblur="if (this.value == '') {this.value = '用户名字';}">
        <input type="text" id="input"  name="aaa" value="输入下方验证码" onfocus="this.value = '';" id="aaa"
               onblur="if (this.value == '') {this.value = '输入下方验证码';}">
        <input type="text" id="code" onclick="createCode()" readonly="true">
        <div class="key">
            <input type="password"  id="nloginpwd" value="" name="password" onfocus="this.value = '';"
                   onblur="if (this.value == '') {this.value = '';}">
        </div>

    <input type="submit" value="Login" id="loginsubmit">

        <%--<input type="button" value="验证" onclick="validate1()"/>--%>
    </form>
</div>
