    ...
    <script>
        ...
        $(function(){
            ...
            $("#tt").datagrid({
                ...
                rownumbers:true,
                loadMsg:"正在加载中....",
                url:"${pageContext.request.contextPath}/contact/contactList.do",
                striped:true,
                columns:[[
                    {field:"ck",checkbox:true, width:50},
                    {field:"id",title:"主键", width:0,hidden:true},
                    {field:"contactname",title:"联系名称",width:50,align:"center"},
                    {field:"contactcontent",title:"联系内容",width:200,align:"center"},
                    ...
                    {field:"contactupdate",title:"修改时间",width:200,align:"center",
                        formatter:function(value,row,index){
                            var unixTimestamp = new Date(value);
                            return unixTimestamp.toLocaleString();
                        }}
                        ...
                        handler:function(){
                            if(editing==undefined)
                            {
                                ...
                                if(rows.length!=1)
                                {
                                    ...
                                    var path = "${pageContext.request.contextPath}/contact/contactedit.do?id="+ids;
                        ...
                        handler:function(){
                            ...
                            if(rows.length>0){
                                ...
                                $.messager.confirm("确认框","您确定要删除吗?",function(b){
                                    if(b)
                                    {
                                        $.post("${pageContext.request.contextPath}/contact/"+ids+"/deleteContactArray.do",function(data){
                                            $.messager.show({
                                                title:"消息",
                                                width:200,
                                                height:100,
