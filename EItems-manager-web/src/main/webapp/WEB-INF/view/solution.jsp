...
<script>
    ...
    $(function(){
        ...
        $("#tt").datagrid({
            ...
            rownumbers:true,
            loadMsg:"正在加载中....",
            url:"${pageContext.request.contextPath}/solutionlist.do",
            striped:true,
            nowrap:false,
            columns:[[
                {field:"ck",checkbox:true, width:50,},
                {field:"id",title:"主键", width:0,hidden:true,},
                {field:'title',title:'方案标题',width:50,align:"left",},
                {field:'point',title:'方案简要',width:50,align:"top"},
                {field:'image',title:'方案图片',width:120,
                    formatter:function(value, rec) {//使用formatter格式化刷子
                        ...
                        if (value == null||value=="") {var aa="${pageContext.request.contextPath}/skin/images/frame/book.gif";
                            ...
                            return str; }else{str = "<img src=\'"+value+"\' onclick='download(\""+aa+"\")'  height='200' width='432'  />";}
                        return str;
                    }},
                {field:"createtime",title:"创建时间",width:50,align:"left",
                    formatter:function(value,row,index){
                        var unixTimestamp = new Date(value);
                        return unixTimestamp.toLocaleString();
                    }
                },
                {field:"updatetime",title:"创建时间",width:50,align:"left",
                    formatter:function(value,row,index){
                        var unixTimestamp = new Date(value);
                        return unixTimestamp.toLocaleString();
                    }
                    ...
                    handler:function(){
                        if(editing==undefined)
                        {
                            ...
                            if(rows.length!=1)
                            {
                                ...
                                var path = "${pageContext.request.contextPath}/solutionToPage.do?id="+ids;
        ...
        <td height="26">
            <table width="%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <%--<input type='button' class="coolbg np" onClick="location='about_news_add.do';" value='添加方案信息' />--%>
                    </td>
                </tr>
            </table>
        </td>
