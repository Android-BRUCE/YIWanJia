  ...
  <tr>
	...
	<!-- Item  Strat -->
      ...
      <!-- Item  End -->
         <!-- Item  Strat -->
         <dl class='bitem'>
             <dt onClick='showHide("items5_1")'><b>新闻管理</b></dt>
         ...
         <dl class='bitem'>
             ...
             <dd style='display:none' class='sitem' id='items7_1'>
                 <ul class='sitemu'>
                     <li><a href='${pageContext.request.contextPath}/case.html' target='main'>公司案例管理</a> </li>
                 </ul>
             </dd>
         </dl>
         <!-- Item  End -->
         <!-- Item  Strat -->
         <dl class='bitem'>
             <dt onClick='showHide("items6_1")'><b>人才招聘管理</b></dt>
         ...
         <!-- Item  Strat -->
         <dl class='bitem'>
             <dt onClick='showHide("items4_1")'><b>关于我们</b></dt>
