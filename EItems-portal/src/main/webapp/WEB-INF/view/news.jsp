...
<ul class="ny_news_list">
	...
	<div id="fengye"><!--分页-->
		...
		<div id="dcms_pager">
			...
			<a class="pgNext" href="${pageContext.request.contextPath}/news/page.aspx?page=1">首页</a>
				<c:if test="${paging.page==1}">
					<a class="pgNext" href="${pageContext.request.contextPath}/news/page.aspx?page=${paging.page}">上一页</a>
				</c:if>
				<c:if test="${paging.page>1}">
				...
				<a href="${pageContext.request.contextPath}/news/page.aspx?page=1">1</a>
				</c:if>
			<c:if test="${paging.totalPage>=2}">
				<a href="${pageContext.request.contextPath}/news/page.aspx?page=2">2</a>
			</c:if>
			<c:if test="${paging.totalPage>=3}">
				<a href="${pageContext.request.contextPath}/news/page.aspx?page=3">3</a>
			</c:if>
			<c:if test="${paging.totalPage>=4}">
				<a href="${pageContext.request.contextPath}/news/page.aspx?page=4">4</a>
			</c:if>
			<c:if test="${paging.totalPage>5}">
				<a href="${pageContext.request.contextPath}/news/page.aspx?page=5">5</a>
			</c:if>
				<c:if test="${paging.page==paging.totalPage}">
					<a class="pgNext" href="${pageContext.request.contextPath}/news/page.aspx?page=${paging.totalPage}">下一页</a>
				</c:if>
				<c:if test="${paging.page<paging.totalPage}">
					<a class="pgNext" href="${pageContext.request.contextPath}/news/page.aspx?page=${paging.page+1}">下一页</a>
				</c:if>
			<a class="pgNext" href="${pageContext.request.contextPath}/news/page.aspx?page=${paging.totalPage}">尾页</a>
