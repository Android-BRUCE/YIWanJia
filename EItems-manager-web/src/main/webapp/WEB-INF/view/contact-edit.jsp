...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>联系方式名称:</td>
	            <td><input class="easyui-textbox" type="text" name="contactname" data-options="required:true" style="width: 280px;" value="${contact.contactname}"></input></td>
	        </tr>
			<tr>
				<td>联系方式内容:</td>
				<td><input class="easyui-textbox" type="text" name="contactcontent" data-options="required:true" style="width: 280px;" value="${contact.contactcontent}"></input></td>
			</tr>
	    </table>
...
<script type="text/javascript">
    ...
    function submitForm(){
        ...
        $.post("${pageContext.request.contextPath}/contact/saveEdit.do",$("#itemAddForm").serialize(), function(data){
            if(data.status == 200){
