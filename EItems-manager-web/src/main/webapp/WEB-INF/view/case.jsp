    ...
    <script>
        $(function(){
            ...
            $("#tt").datagrid({
                ...
                rownumbers:true,
                loadMsg:"正在加载中....",
                url:"${pageContext.request.contextPath}/case/list.do",
                striped:true,
                nowrap:false,
                columns:[[
                    {field:"ck",checkbox:true, width:50,},
                    {field:"id",title:"主键", width:0,hidden:true,},
                    {field:'image',title:'案例图片',width:400,
                        formatter:function(value, rec) {//使用formatter格式化刷子
                            ...
                            if (value == null||value=="") {var aa="http://localhost:8080/skin/images/frame/book.gif";
                                ...
                                return str; }else{str = "<img src=\'"+value+"\' onclick='download(\""+aa+"\")'  height='200' width='800'  />";}
                            return str;
                        }},
                        ...
                        handler:function(){
                            ...
                            if(rows.length>0){
                                ...
                                $.messager.confirm("确认框","您确定要删除吗?",function(b){
                                    if(b)
                                    {
                                        $.post("${pageContext.request.contextPath}/case/"+ids+"/delete.do?",function(data){
                                            $.messager.show({
                                                title:"消息",
                                                width:200,
                                                height:100,
