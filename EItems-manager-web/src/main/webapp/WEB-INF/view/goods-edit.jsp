...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>产品名称:</td>
	            <td><input class="easyui-textbox" type="text" name="goodsttile" data-options="required:true" style="width: 280px;" value="${goods.goodsttile}"></input></td>
	        </tr>
	        <tr>
	            <td>产品简述:</td>
	            <td><input class="easyui-textbox" name="point" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;" value="${goods.point}"></input></td>
	        </tr>
	        <tr>
	            <td>产品分类:</td>
	            <td>
	        ...
	        <tr>
	            <td>产品具述:</td>
	            <td>
	                <textarea style="width:800px;height:300px;visibility:hidden;" name="goodsdesc">${goods.goodsdesc}</textarea>
	            </td>
	        </tr>
	    </table>
