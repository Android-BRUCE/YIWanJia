        ...
        <table cellpadding="5">
            <tr>
                ...
                <td>
                    <div>
                        <ul>
                            <li><a href="${case1.image}" target="_blank"><img
                                    src="${case1.image}" width="1000"
            ...
            <tr>
                <td>产品图片（格式1000x322）:</td>
                <td>
                    <a href="javascript:void(0)" class="easyui-linkbutton picFileUpload">上传图片</a>
                    <input type="hidden" name="image" id="image"/>
                    <input type="hidden" name="id" value="${case1.id}"/>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.post("${pageContext.request.contextPath}/case/edit.do", $("#itemAddForm").serialize(), function (data) {
            if (data.status == 200) {
