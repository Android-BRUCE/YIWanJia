    ...
    $(function(){
        ...
        $("#tt").datagrid({
            ...
            columns:[[
                ...
                {field:'title',title:'活动名称',width:50,align:"center",},
                {field:'point',title:'活动简述',width:100,align:"left"},
                {field:'image',title:'活动封面图片',width:200,
                    ...
                    handler:function(){
                        if(editing==undefined)
                        {
                            ...
                            if(rows.length!=1)
                            {
                                ...
                                var path = "${pageContext.request.contextPath}/about_activity_edit.html?id="+ids;
                    ...
                    handler:function(){
                        ...
                        if(rows.length>0){
                            ...
                            $.messager.confirm("确认框","您确定要删除吗?",function(b){
                                if(b)
                                {
                                    $.post("${pageContext.request.contextPath}/aboutActivity/delete/"+ids+"/deleteActivity.do?",function(data){
                                        $.messager.show({
                                            title:"消息",
                                            width:200,
                                            height:100,
