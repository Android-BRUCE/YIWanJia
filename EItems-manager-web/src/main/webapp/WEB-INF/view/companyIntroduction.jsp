	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td></td>
	            <td>
	                <textarea style="width:1100px;height:500px;visibility:hidden;" name="content">${introduction.content}</textarea>
	            </td>
	        </tr>
	    </table>
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		$.post("${pageContext.request.contextPath}/company/introduction.do",$("#itemAddForm").serialize(), function(data){
			if(data.status == 200){
