...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>活动标题:</td>
	            <td><input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width: 280px;" value="${activity.title}"></input></td>
	        </tr>
	        <tr>
	            <td>活动简述:</td>
	            <td><input class="easyui-textbox" name="point" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;" value="${activity.point}"></input></td>
	        </tr>
			<tr>
				<td>活动图片（上传一张）:</td>
				<td>
					<a href="javascript:void(0)" class="easyui-linkbutton picFileUpload">卡片式图片上传</a>
					<%--<a href="javascript:void(0)" class="easyui-linkbutton onePicUpload">卡片式图片上传</a>--%>
	        ...
	        <tr>
	            <td>活动具述:</td>
	            <td>
	                <textarea style="width:800px;height:300px;visibility:hidden;" name="content">${activity.content}</textarea>
	            </td>
	        </tr>
	    </table>
...
//      TT.initOnePicUpload();
	...
	function submitForm(){
		...
		$.post("${pageContext.request.contextPath}/aboutActivity/saveEdit.do",$("#itemAddForm").serialize(), function(data){
			if(data.status == 200){
