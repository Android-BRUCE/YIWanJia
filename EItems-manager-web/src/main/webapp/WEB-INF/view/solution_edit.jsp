...
<div style="padding:10px 10px 10px 10px">
    <form id="itemAddForm" class="itemForm" method="post">
        <table cellpadding="5">
            <tr>
                <td>方案标题:&nbsp;&nbsp;<input class="easyui-textbox" type="text" name="title" data-options="required:true"
                                            style="width: 280px;" value="${solution.title}"></input></td>
            </tr>
            <tr>
                <td>方案简要:&nbsp;&nbsp;<input value="${solution.point}" class="easyui-textbox" name="point"
            ...
            <tr>
                <td>目前产品图片：&nbsp;&nbsp;
                    <div>
                        <ul>
                            &nbsp;&nbsp;
                            <li><a href="${solution.image}" target="_blank"><img
                                    src="${solution.image}" width="800"
            ...
            <tr>
                <td>方案具述:&nbsp;&nbsp;
                    <textarea style="width:1100px;height:500px;visibility:hidden;"
                              name="content">${solution.content}</textarea>
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.post("${pageContext.request.contextPath}/solution/modify.do", $("#itemAddForm").serialize(), function (data) {
            if (data.status == 200) {
